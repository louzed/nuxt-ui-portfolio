  ...
  <div class="border-b border-muted">
    <UContainer class="grid grid-cols-1 lg:grid lg:grid-cols-2 lg:grid-rows-2 lg:border-r lg:border-l border-muted">
      <div class="border-b lg:border-b-0 lg:border-r border-muted py-12 lg:row-span-2">
        <ClientOnly>
          <img :src="getImage('about')" alt="Beschreibung des Bildes" class="aspect-square object-cover object-center" />
        </ClientOnly>
      </div>

      <div class="flex flex-col justify-center border-b border-muted px-8 py-12">
        <div class="space-y-2">
          ...
          <div class="flex gap-2">
            <DrawerCv />
            <UButton to="https://github.com/louzed" target="_blank" icon="i-simple-icons-github" variant="ghost"
              color="neutral" size="lg" />
            <UButton to="https://dribbble.com/mbiereth" target="_blank" icon="i-mingcute-dribbble-fill" variant="ghost"
              color="neutral" size="lg" />
          </div>
        </div>
      </div>

      <div class="px-8 py-12 flex flex-col justify-center">
        <div class="space-y-2">
